...
static Tk_OptionSpec dragSpecs[] = {
    {TK_OPTION_BOOLEAN, "-enable", (char *) NULL, (char *) NULL,
     ...
     0, (ClientData) NULL, 0},
    {TK_OPTION_CUSTOM, "-header", (char *) NULL, (char *) NULL,
     (char *) NULL, -1, Tk_Offset(TreeCtrl, columnDrag.header),
     TK_OPTION_NULL_OK, (ClientData) &TreeCtrlCO_header, 0},
    ...
    )
{
	...
	QUAL_STATE,
#endif
	QUAL_TAG, QUAL_VISIBLE, QUAL_NOT_TAIL,
	QUAL_NOT_VISIBLE
    };
    ...
    )
{
    ...
    return tree->headerHeight = Tree_HeightOfHeaderItems(tree);
#else
    TreeColumn column;
    int height;
